...
<form action="editEprofileExecute.php" method="post" enctype="multipart/form-data" style="margin-left: 25%; color: green;background: orange; align-items: center;width: 50%;padding-left: 15%;font-size: 20px; font-family: verdana;">
	<br>
